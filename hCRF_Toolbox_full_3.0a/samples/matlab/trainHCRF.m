...
if GHCRF
    matHCRF('createToolbox', 'ghcrf', params.nbHiddenStates);
else
    matHCRF('createToolbox', 'hcrf', params.nbHiddenStates);
end
...
if isfield(params,'windowSize')
   matHCRF('addFeatureFunction','WindowRawFeatures',params.windowSize);
end
...
if isfield(params,'windowRecSize')

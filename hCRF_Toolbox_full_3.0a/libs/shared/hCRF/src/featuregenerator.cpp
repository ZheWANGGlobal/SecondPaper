...
// I think having different return types of two functions is okay as long
// as they have different function signatures. -Yale
											 ...
											 int seqLabel)
{
	...
	// getAllFeatures will change the value stored in the destination of the

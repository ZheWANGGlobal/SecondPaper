...
ToolboxLVPERCEPTRON::ToolboxLVPERCEPTRON(int nbHiddenStatesPerLabel)
	: Toolbox(),
	numberOfHiddenStatesPerLabel(nbHiddenStatesPerLabel)
{
}

/*ToolboxLVPERCEPTRON::ToolboxLVPERCEPTRON(int nbHiddenStatesPerLabel,int opt, int windowSize):Toolbox()
{
...
void ToolboxLVPERCEPTRON::initToolbox()
{	
	Toolbox::initToolbox(); 
	pEvaluator = new EvaluatorLVPERCEPTRON (pInferenceEngine, pFeatureGenerator);
}

void ToolboxLVPERCEPTRON::initModel(DataSet &X)
{
...
double ToolboxLVPERCEPTRON::test(DataSet& X, char* filenameOutput, char* filenameStats)
{

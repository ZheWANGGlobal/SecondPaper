...
/*ToolboxHMMPerceptron::ToolboxHMMPerceptron(int opt, int windowSize):Toolbox()
{
	init(opt, windowSize);
}*/
...
void ToolboxHMMPerceptron::initToolbox()
{
	//Features.
	...
	pInferenceEnginePerceptron = new InferenceEnginePerceptron();

	pGradientPerceptron = new GradientHMMPerceptron(pInferenceEnginePerceptron, pFeatureGenerator);
	//pEvaluator = new EvaluatorCRF(pInferenceEngine, pFeatureGenerator);
}


void ToolboxHMMPerceptron::initModel(DataSet &X)
{
...
void ToolboxHMMPerceptron::train(DataSet &X, bool bInitWeights)
{
	initToolbox();
	if(bInitWeights)
	{
	...
	//Start training
	pOptimizer->optimize(pModel,&X, pEvaluator,pGradientPerceptron);
}

double ToolboxHMMPerceptron::test(DataSet& X, char* filenameOutput, char* filenameStats)
{

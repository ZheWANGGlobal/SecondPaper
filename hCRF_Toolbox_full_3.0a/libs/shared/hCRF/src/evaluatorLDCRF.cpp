...
double EvaluatorLDCRF::computeError(DataSequence* X, Model* m, bool bComputeMaxMargin)
{
...
void EvaluatorLDCRF::computeStateLabels(DataSequence* X, Model* m, iVector* vecStateLabels, dMatrix * probabilities, bool bComputeMaxMargin)
/*

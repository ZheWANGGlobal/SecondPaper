...
int InferenceEngineBrute::computeSingleBelief(FeatureGenerator* fGen, Model* model,
...
{
	if( bMaxProduct )
		throw HcrfNotImplemented("InferenceEngineBrute for max-margin is not implemented");
...
double InferenceEngineBrute::computePartition(FeatureGenerator* fGen,DataSequence* X, Model* crf, int seqLabel, bool bUseStatePerNodes, bool bMaxProduct)
{
	if( bMaxProduct )
		throw HcrfNotImplemented("InferenceEngineBrute for max-margin is not implemented");

...
elseif strcmp(model.modelType,'crfRealtime')
    [ll newlabels] = testCRFRealtime(model, seqs, labels);
elseif strcmp(model.modelType,'cnf')
...
elseif strcmp(model.modelType,'ldcrfRealtime')
    [ll newlabels] = testLDCRFRealtime(model, seqs, labels);
elseif strcmp(model.modelType,'ldcnf')
...
elseif strcmp(model.modelType,'me')
    [ll newlabels] = testME(model, seqs, labels);
elseif strcmp(model.modelType,'lhcrf') || strcmp(model.modelType,'chcrf') || strcmp(model.modelType,'fchcrf')
    [ll newlabels] = testMSHCRF(model, seqs, labels);
end

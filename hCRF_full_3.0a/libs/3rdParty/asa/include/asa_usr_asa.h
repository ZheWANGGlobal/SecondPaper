...
***********************************************************************/
  ...
  /* $Id: asa_usr_asa.h,v 26.23 2007/01/31 20:13:33 ingber Exp ingber $ */
...
#define QUENCH_PARAMETERS_SCALE FALSE
#endif
...
//Modified By Hugues Salamin (to allow forward declaration in C++)
typedef struct USER_DEFINES{

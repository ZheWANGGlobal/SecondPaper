...
int InferenceEngineFB::computeSingleBelief(FeatureGenerator* fGen, Model* model,
...
{
	if( bMaxProduct )
		throw HcrfNotImplemented("InferenceEngineFB for max-margin is not implemented");

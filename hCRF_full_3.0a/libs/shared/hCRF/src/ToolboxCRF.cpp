...
void ToolboxCRF::openPort(PORT_NUMBER portNumber, int windowSize, int bufferLength)
{
...
void ToolboxCRF::closePort(PORT_NUMBER portNumber)
{
	if(portNumberMap.find(portNumber) != portNumberMap.end())
	{
...
bool ToolboxCRF::insertOneFrame(PORT_NUMBER portNumber, const dVector* const features, dVector* prob)
{
